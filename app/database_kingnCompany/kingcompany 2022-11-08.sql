...
--
-- Host: 127.0.0.1
-- Tempo de geração: 08-Nov-2022 às 16:50
...
(18, '2022_11_08_141821_create_portugalInfoType_table', 4),
(19, '2022_11_08_142643_add_category_portugal_info_table', 5);
...
CREATE TABLE `portugalinfotypes` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `textPortugalInfoType` longtext COLLATE utf8mb4_unicode_ci NOT NULL,
  `imgPortugalInfoType` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `hyperlinkPortugalInfoType` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `estadoID` bigint(20) UNSIGNED NOT NULL DEFAULT 1,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
